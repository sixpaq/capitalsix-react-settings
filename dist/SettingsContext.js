...
exports.SettingsProvider = exports.SettingsConsumer = void 0;
...
var SettingsContext = /*#__PURE__*/_react.default.createContext({});
...
var SettingsProvider = function SettingsProvider(_ref) {
  ...
  (0, _react.useEffect)(function () {
    fetch(filename || '/settings.json').then(function (response) {
...
function withSettings(WrappedComponent) {
  return function (props) {
    return /*#__PURE__*/_react.default.createElement(SettingsConsumer, null, function (settings) {
